...
const CATEGORIES = ['Computer', 'Monitor', 'Keyboard', 'Mouse', 'Printer', 'Networking', 'AVR/UPS', 'Projector', 'Other'];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex flex-wrap items-end gap-3 print:hidden">
          ...
          >
            ...
            {[...new Set([...STATUSES, ...BORROW_STATUSES])].map((status) => <option key={status} value={status}>{status}</option>)}
          </Select>
          <Input
            label="Borrower ID"
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        ...
        <SummaryGrid title="Low Stock Report" data={{ LowStock: reports?.inventory?.lowStock || 0 }} />
        <SummaryGrid title="Overdue Borrow Report" data={{ Overdue: reports?.borrow?.overdue || 0 }} />
