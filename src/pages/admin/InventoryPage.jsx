...
<<<<<<< HEAD
      ...
      header: 'Photo',
      render: (value, row) => (
        <div className="h-12 w-12 overflow-hidden rounded border border-gray-300 bg-gray-100 dark:border-gray-700 dark:bg-gray-800">
          {value ? (
            <img src={value} alt={row.name} className="h-full w-full object-cover" />
          ) : (
