...
<<<<<<< HEAD
    ...
    'Low Stock': 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300',

    // Borrow status
    Pending: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300',
    Approved: 'bg-primary-100 text-primary-800 dark:bg-primary-900 dark:text-primary-200',
    Rejected: 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300',
    Returned: 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300',
    Overdue: 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300',
    'Due Soon': 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300',

    // Maintenance status
    'In Progress': 'bg-teal-100 text-teal-800 dark:bg-teal-900 dark:text-teal-300',
