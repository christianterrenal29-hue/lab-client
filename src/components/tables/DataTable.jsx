...
<<<<<<< HEAD
              className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 bg-white text-gray-900 shadow-sm transition-colors hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 dark:hover:border-gray-500"
=======
...
>>>>>>> 6f02213f17862507603ace70185a986836e978b9
      ...
      {/* Table */}
<<<<<<< HEAD
      <div className="overflow-x-auto rounded-xl border border-gray-300 bg-white shadow-[0_4px_12px_rgba(0,0,0,0.08)] dark:border-gray-700 dark:bg-gray-800 dark:shadow-[0_4px_12px_rgba(0,0,0,0.25)]">
        <table className="w-full">
          <thead className="bg-primary-50 dark:bg-gray-900">
=======
...
<<<<<<< HEAD
                    ...
                    sortable && column.sortable !== false && 'cursor-pointer select-none hover:bg-primary-100 dark:hover:bg-gray-700'
=======
...
<<<<<<< HEAD
                  className="hover:bg-primary-50/80 dark:hover:bg-gray-700/60 transition-colors"
=======
